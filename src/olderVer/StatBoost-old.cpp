...
void StatBoosterWorld::OnAfterConfigLoad(bool /*reload*/)
{
    ...
    if (sBoostConfigMgr->Enable)
    {
        ...
        sBoostConfigMgr->OnLootItemEnable = sConfigMgr->GetOption<bool>("StatBooster.OnPlayerLootItemEnable", true);
        sBoostConfigMgr->OnQuestRewardItemEnable = sConfigMgr->GetOption<bool>("StatBooster.OnPlayerQuestRewardItemEnable", true);
